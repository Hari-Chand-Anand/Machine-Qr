    ...
    <div className="space-y-4">
      ...
      <Card className="p-6">
        <form action={createMachineAction} className="space-y-4">
          <div>
            <label className="text-sm text-zinc-300">Machine ID (optional)</label>
            <Input name="machineId" placeholder="e.g., DY-4412P-001" />
          </div>

          <div>
            <label className="text-sm text-zinc-300">Machine Name</label>
            <Input name="name" placeholder="e.g., DUKE DY-4412P Pattern Sewer" required />
          </div>

          <div>
            <label className="text-sm text-zinc-300">Machine Specs / Catalog (Google Drive link)</label>
            <Input
              name="driveLink"
          ...
          <div>
            <label className="text-sm text-zinc-300">Service & Installation Reports (Google Sheets link)</label>
            <Input
              name="sheetsLink"
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              <label className="text-sm text-zinc-300">WhatsApp Number (optional)</label>
            ...
            <div>
              <label className="text-sm text-zinc-300">WhatsApp Message Template (optional)</label>
              <Textarea
